...
import { Menu, X, Film, Compass, Tv, Play, LogIn, CreditCard, Search, Loader2, Star } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="container-custom flex items-center justify-between gap-4">
        ...
        <a href="/" className="flex items-center gap-2 group z-50 flex-shrink-0">
        ...
        <div ref={searchRef} className="hidden md:block relative w-48 lg:w-64 xl:w-72 z-50">
          <div className="relative">
            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted/60">
              {loading ? (
            ...
            <input
              ...
              className="w-full bg-surface/65 border border-themeBorder/80 text-xs text-text placeholder:text-muted/50 pl-9 pr-8 py-2.5 focus:outline-none focus:border-primary focus:bg-card transition-all rounded-sharp backdrop-blur-md"
            />
            {query && (
              <button
                onClick={() => {
          ...
          {isDropdownOpen && query.trim().length >= 2 && (
            <div className="absolute top-full right-0 left-0 mt-2 bg-background/95 backdrop-blur-xl border border-themeBorder rounded-sharp shadow-2xl p-2 max-h-96 overflow-y-auto z-50 scrollbar-thin">
              ...
              {results.map((item) => {
                ...
                const poster = item.posterUrl || "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=200&auto=format&fit=crop&q=80";
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-end gap-0.5 flex-shrink-0">
                      ...
                      <span className={`text-[8px] font-black uppercase tracking-wider px-1 py-0.5 rounded-sharp ${
                        isMovie 
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <span className="text-[10px] text-muted truncate block">{originalTitle} ({item.year})</span>
                    </div>
