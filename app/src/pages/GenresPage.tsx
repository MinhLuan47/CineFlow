...
import { Button, Badge, Container, Card, SectionHeader } from "../components";
...
export const GenresPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <Container py="none" className="py-10 min-h-[60vh]">
  ...
  if (error) {
    return (
      <Container py="none" className="py-20 min-h-[60vh] flex flex-col items-center justify-center text-center">
  ...
  return (
    <Container py="none" className="py-10 min-h-[60vh]">
      <SectionHeader
        ...
        description="Duyệt tìm bộ phim yêu thích của bạn theo từng danh mục thể loại đặc thù."
            ...
            {movieGenres.map((genre) => {
              ...
              return (
                ...
                >
                  <Card
                    variant="glass"
                    className={`relative flex flex-col items-start justify-between transition-all duration-300 ${style.glowClass} overflow-hidden min-h-[140px]`}
                  >
